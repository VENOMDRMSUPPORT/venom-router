...
## Theming & density
- `data-theme="venom-dark" | "venom-light" | "venom-hc"` on the root element (dark is also the `:root` default); `data-density="comfortable" | "compact"` alongside it.
