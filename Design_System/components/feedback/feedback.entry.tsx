...
import { Alert, Banner, Toast, EmptyState, ErrorState, Spinner, Progress, Meter, Skeleton, Button, ToastProvider, toast } from "../../src/index";
    ...
    <ToastProvider>
      <div className="stack">
        ...
        <div className="stack" style={{ gap: 8 }}>
          <span className="vn-caption">Toast Triggers</span>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <Button size="sm" onClick={() => toast.success("Healthy Toast", { detail: "Operation completed successfully" })}>
              Healthy / Success
            </Button>
            <Button size="sm" onClick={() => toast.danger("Critical Toast", { detail: "System error occurred" })}>
              Critical / Danger
            </Button>
            <Button size="sm" onClick={() => toast.warning("Warning Toast", { detail: "High memory utilization" })}>
              Warning
            </Button>
            <Button size="sm" onClick={() => toast.info("Info Toast", { detail: "System updated to v2.4" })}>
              Info
            </Button>
            <Button size="sm" onClick={() => toast.loading("Loading Toast", { detail: "Fetching provider list..." })}>
              Loading
            </Button>
            <Button size="sm" onClick={() => toast.custom("Custom / Promise Toast", { detail: "Custom tone toast notification", tone: "custom" })}>
              Promise / Custom
            </Button>
          </div>
        </div>
