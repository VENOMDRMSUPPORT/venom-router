...
const SESSION_TIMES = {
  idle_expires_at: "2026-07-24T00:30:00Z",
  absolute_expires_at: "2026-07-24T12:00:00Z",
};
  ...
  it("renders First-run setup when status says setup is incomplete, and a successful setup enters the authenticated area", async () => {
    const fetchMock = createFetchMock({
      "GET /api/control/v1/auth/status": () =>
        jsonResponse(200, { data: { setup_complete: false } }),
